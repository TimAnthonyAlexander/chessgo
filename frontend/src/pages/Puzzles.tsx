...
export default function Puzzles() {
    ...
    const userStats = user
        ? {
              ...
              provisional: user.provisional?.puzzle ?? false,
          }
        : null
            ...
            {TIME_FORMATS.map((f) => {
                ...
                return (
                    ...
                    >
                        ...
                        <Typography
                            sx={{ fontSize: 11, color: active ? 'var(--accent)' : 'var(--muted)' }}
                        >
                            {f.tag}
                        </Typography>
                    </Box>
            ...
            >
                <Box
                    sx={{
                        ...
                        alignItems: 'center',
                        gap: 1,
                        color: lowTime ? '#e0796b' : 'var(--text-dim)',
                    }}
                >
        ...
        <Card sx={{ p: 2.25, mt: 1.5 }}>
            ...
            >
                ...
                <Typography sx={{ fontFamily: 'var(--font-mono)', fontSize: 12 }}>
                    <Box component="span" sx={{ color: '#7bb661' }}>
                        {wins}W
                    </Box>
                    ...
                    <Box component="span" sx={{ color: '#e0796b' }}>
                        {losses}L
                    </Box>
                </Typography>
            </Box>

    ...
    >
      ...
      <DialogContent>
        ...
        >
          ...
          <Typography sx={{ fontFamily: 'var(--font-mono)', fontSize: 16, color: 'var(--text)' }}>
            {pool}
          </Typography>
          <Typography sx={{ fontFamily: 'var(--font-mono)', fontSize: 13, color: meta.color, ml: 'auto' }}>
            {cat}
          </Typography>
        </Box>
      </DialogContent>
      ...
      <DialogActions sx={{ px: 3, pb: 2.5 }}>
        ...
        <Button onClick={handlePlay} variant="contained" sx={{ textTransform: 'none', fontWeight: 600 }}>
          Play
        </Button>
      </DialogActions>
    </Dialog>

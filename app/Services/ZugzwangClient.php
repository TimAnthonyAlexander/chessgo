 ...
 * /bestmove, /perft, /status, /candidates, /analyze-game
 * (WIRING_RECON.md §A) — so this is just {@see GomachineClient} bound to a
 * different base URL (ZUGZWANG_URL, default http://127.0.0.1:6476).
 *
 * zugzwang 501s /sf-bestmove and the Duck/Crazyhouse variant routes (Wave 3,
 * not yet implemented) — never call those methods on this client directly.
